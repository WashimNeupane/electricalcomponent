...
%%Plot runtime for Jacobi, GaussSeidel and Conjugate Gradient
...
%%Overall Erros in iterative methods with changing values of tolerance
...
%%Iteration Counts for each iterative steps
...
% index = 1:length(iteration);
% plot(index,iteration);
